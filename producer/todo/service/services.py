from code.todo.main import Product
...
async def add_item(item:producer_pb2.Product_Proto,session:Session):
    try:
        create_item = Item(name=Product.name, description=Product.description)
